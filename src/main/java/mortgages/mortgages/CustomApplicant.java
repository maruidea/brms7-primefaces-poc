...
@ManagedBean
@SessionScoped
public class CustomApplicant implements java.io.Serializable {
    ...
    public CustomApplicant() {
    }
    
    public CustomApplicant(Integer age, java.util.Date applicationDate, String creditRating, String name, Boolean approved) {
        this.age = age;
